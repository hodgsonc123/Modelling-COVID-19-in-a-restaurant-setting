...
<experiments>
  ...
  <experiment name="2 reduced booking time" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="2 capacity t" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 20000</exitCondition>
    <metric>averageRisk</metric>
  ...
  <experiment name="5 masks" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 18000</exitCondition>
    <metric>averageRisk</metric>
  ...
  <experiment name="7 windows vs mch" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 18000</exitCondition>
    <metric>averageConcentration</metric>
  ...
  <experiment name="7 windows vs mch 2" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 18000</exitCondition>
    <metric>averageConcentration</metric>
  ...
  <experiment name="8 booking ans service" repetitions="40" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 18000</exitCondition>
    <metric>averageConcentration</metric>
